    ...
    <div className="w-full h-full bg-white rounded-xl border border-gray-200 shadow-xl overflow-hidden">
      ...
      <div className="h-[calc(100%-81px)] flex items-center justify-center p-16 bg-gradient-to-br from-slate-50 via-white to-blue-50">
        <div className="text-center max-w-lg">
          ...
          <button className="bg-black/80 backdrop-blur-sm text-white px-8 py-4 rounded-xl font-semibold hover:bg-black/90 transition-all duration-200 shadow-lg hover:shadow-2xl transform hover:-translate-y-0.5 border border-white/10">
            Get Started
          </button>
        </div>
      </div>
