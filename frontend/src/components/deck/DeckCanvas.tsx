...
export function DeckCanvas({ deckId, activeSlideIndex = 0 }: DeckCanvasProps) {
  ...
  return (
    <div className="relative w-full h-full flex flex-col rounded-3xl border border-[rgba(97,81,255,0.15)] bg-white/70 backdrop-blur-xl shadow-[0_30px_80px_rgba(11,18,32,0.18)] overflow-hidden">
      ...
      {/* Canvas Header */}
      <div className="relative flex items-center justify-between px-8 py-5 border-b border-[rgba(17,24,39,0.08)]/60 bg-white/65 backdrop-blur-xl">
            ...
            {isEditing ? (
              <>
                <button
                  ...
                  className="px-3.5 py-1.5 rounded-full border border-[rgba(17,24,39,0.1)] text-xs font-semibold text-slate-600 hover:text-slate-900 hover:border-[rgba(17,24,39,0.2)] transition-all duration-200"
                >
                  Cancel
                </button>
                <button
                  onClick={saveSlide}
                  disabled={isSaving}
                  className="px-4.5 py-1.5 rounded-full bg-[var(--color-violet)] text-white text-xs font-semibold shadow-[0_12px_28px_rgba(97,81,255,0.35)] hover:shadow-[0_18px_36px_rgba(97,81,255,0.4)] transition-all duration-200 disabled:opacity-60"
                >
              ...
              <>
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-[rgba(17,24,39,0.08)] text-xs font-semibold text-slate-600 hover:text-slate-900 hover:border-[rgba(17,24,39,0.18)] transition-all duration-200"
                >
                ...
                <button
                  onClick={deleteSlide}
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[rgba(255,111,97,0.12)] text-[var(--color-coral)] text-xs font-semibold hover:bg-[rgba(255,111,97,0.2)] transition-all duration-200"
                >
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {isLoading ? (
              ...
              <div className="relative max-w-2xl mx-auto text-center">
                <div className="w-24 h-24 mx-auto mb-8 rounded-[24px] bg-gradient-to-br from-[rgba(97,81,255,0.25)] via-[rgba(63,209,201,0.18)] to-white shadow-[0_25px_60px_rgba(15,23,42,0.12)] flex items-center justify-center">
                  <svg className="w-11 h-11 text-[var(--color-violet)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
